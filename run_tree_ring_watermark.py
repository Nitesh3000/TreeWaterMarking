...
def main(args):
    ...
    for i in tqdm(range(args.start, args.end)):
        ...
        if args.with_tracking:
            ...
            print(f'Appended clip_scores: {clip_scores}')
            print(f'Appended clip_scores_w: {clip_scores_w}')
